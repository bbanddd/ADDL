...
parser.add_argument('studySpecificTemplate',
...
studySpecificTemplate = args.studySpecificTemplate
...
exec_cmd('cp ' + studySpecificTemplate + ' ' + inputDir + 'struc/template_GM.nii.gz')
